...
import cm.studio.devbee.pocketexam.activity.ChoixFinalActivity;
...
public class SecondAdapter extends  RecyclerView.Adapter<SecondAdapter.ViewHolder>{
    ...
    public SecondAdapter(List<Bepc_model> bepc_modelList, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.item_card.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick(View v) {
                Intent gotolist=new Intent (context,ChoixFinalActivity.class );
                gotolist.putExtra ( "matiere",name );
