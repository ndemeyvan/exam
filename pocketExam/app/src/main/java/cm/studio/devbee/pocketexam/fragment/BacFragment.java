...
public class BacFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bepc_modelList.add ( new Bepc_model ( "Bac A4 Allemand" ) );
        bepc_modelList.add ( new Bepc_model ( "Bac A4 Espagnol" ) );
        bepc_modelList.add ( new Bepc_model ( "Bac D" ) );
        bepc_modelList.add ( new Bepc_model ( "Bac C" ) );
        bac_recycler=v.findViewById ( R.id.bac_recycler );
        bepc_adapter=new Bepc_adapter (bepc_modelList,getActivity());
        bac_recycler.setAdapter ( bepc_adapter );
        bac_recycler.setLayoutManager(new LinearLayoutManager(getActivity(),LinearLayoutManager.VERTICAL,false));
        return v;
    }
